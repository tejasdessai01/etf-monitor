/**
 * seed-db.mjs
 * One-time script to populate Supabase with all seed ETFs.
...
const SEED_ETFS = [
  ...
  { ticker: 'XLC',  name: 'Communication Services Select Sector',issuer: 'State Street', category: 'Sector',         sub_category: 'Comm. Services',   aum: 20000000000,   expense_ratio: 0.09,   inception_date: '2018-06-18', exchange: 'NYSE Arca' },
  ...
  { ticker: 'VCIT', name: 'Vanguard Intermediate-Term Corp ETF', issuer: 'Vanguard',     category: 'Fixed Income',   sub_category: 'Corp Bond',        aum: 45000000000,   expense_ratio: 0.04,   inception_date: '2009-11-19', exchange: 'NYSE Arca' },
  { ticker: 'LQD',  name: 'iShares iBoxx $ Investment Grade Corp',issuer: 'BlackRock',  category: 'Fixed Income',   sub_category: 'Corp Bond',        aum: 33000000000,   expense_ratio: 0.14,   inception_date: '2002-07-22', exchange: 'NYSE Arca' },
  ...
  { ticker: 'HYG',  name: 'iShares iBoxx $ High Yield Corp ETF', issuer: 'BlackRock',    category: 'Fixed Income',   sub_category: 'High Yield',       aum: 14000000000,   expense_ratio: 0.48,   inception_date: '2007-04-04', exchange: 'NYSE Arca' },
  ...
  { ticker: 'AOA',  name: 'iShares Core Aggressive Alloc ETF',   issuer: 'BlackRock',    category: 'Multi-Asset',    sub_category: 'Aggressive Alloc', aum: 1800000000,    expense_ratio: 0.15,   inception_date: '2008-11-04', exchange: 'NYSE Arca' },
...
async function main() {
  console.log(`[seed-db] Seeding ${SEED_ETFS.length} ETFs into Supabase...`);

  const rows = SEED_ETFS.map(e => ({
    ...e,
  ...
  console.log(`[seed-db] Done — seeded ${SEED_ETFS.length} ETFs`);
}
